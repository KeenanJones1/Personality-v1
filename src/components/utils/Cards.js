...
export const CardDef = styled.div.attrs({
 ...
 margin: 0 auto;
 box-shadow: 0 0 20px 0 rgba(0,0,0,0.3);
 background-color: ${colors.$colorCardBg};
 background-size: 3px 3px;
 color: #fff;
 ${media.tablet `width: 90%;`};
 ${media.laptop`width: 60%;`};
 h1{
  ...
  text-align: center;
  margin-top: 2em;
  ${media.tablet `font-size: 1.5em; letter-spacing: 1px; margin-top: 3em;`};
  ${media.laptop`font-size: 2em; 
  letter-spacing: 2px; margin-top: 1.5em;`};
 }
 .close{
  position: absolute;
  left: 3%;
